...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="static/images/logo_image8.jpg">
  <!-- Custom Theme files -->
            ...
            <div class="container">
                ...
                <div id="navbar" class="col-md-10 navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav wow fadeInRight animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
			            ...
			            <li><a href="#/listAllPosts">Manage Blog</a></li>
			            <li><a href="#/tenderAlert">Tender Notifications</a></li>
			            <li><a href="#/listAllUsers">Manage Users</a></li>
			            
			            <li><a href="javascript:document.getElementById('logout').submit()">Logout</a>
						</li>
