...
<head>
  ...
  <!-- Custom Theme files -->
    <meta name="keywords" content="glaubentek, glaubentek BuildEco, glaubentek BuildEco Pvt. Ltd, Ranchi, glaubentek company
    Real Estate in Ranchi, Construction consultanancy in Ranchi, Builders in Ranchi, glaubentek Building Construction, Building Construction, Construction Tender, Guest house for marriage, good guest house in ranchi,  Sikaria Homes,
            ...
            <div class="container">
                ...
                <div id="navbar" class="col-md-10 navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav wow fadeInRight animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
			            ...
			            <li><a href="#/sikariaHome">Sikaria Homes</a></li>
